...
#| fig-width: 8
#| fig-height: 6
#| fig-alt: "Six jittered scatterplots, each with the count response y on the y-axis and one predictor on the x-axis: Acacia, Bark, Habitat, Shrubs, Stags, and Stumps."
...
**7.** Using the reduced model from part 6, give an estimate of the mean number of species when the bark index is 8, the habitat score is 4, and the number of ~~stumps~~ stags is 10. Give a 95% confidence interval for this estimate by treating the $\log(\hat{\mu})$ as approximately normally distributed. Why is this justified?
