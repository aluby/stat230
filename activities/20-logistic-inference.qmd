...
```{r}
#| fig-alt: "Scatterplot of average response residual on the y-axis against predicted log odds on the x-axis, with a horizontal reference line at zero."
...
```{r}
#| fig-alt: "Scatterplot of average response residual on the y-axis against the mean predictor value within each bin on the x-axis, with a horizontal reference line at zero."
news_aug |>
...
```{r}
#| fig-alt: "A Pearson residual plot for the fitted model, with a smoother overlaid."
...
#| fig-width: 8
#| fig-height: 3
#| fig-alt: "Pearson residuals plotted against each predictor in the model, one panel per predictor, each with a smoother overlaid."
