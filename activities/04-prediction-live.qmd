...
```{webr}
#| min-lines: 3
#| fig-alt: "Scatterplot with education on the x-axis and income on the y-axis."
...
```{webr}
#| fig-alt: "Scatterplot with education on the x-axis and income on the y-axis, with a fitted straight line and two shaded interval bands overlaid."
gf_point(income ~ education, data = city) |>
