...
```{r}
#| fig-alt: "Plot showing an estimate and its confidence interval for each model term, with a horizontal reference line at zero."
broom::tidy(moth_glm, conf.int = TRUE, conf.level = .9) |>
...
```{r}
#| fig-alt: "Plot showing an estimate and its confidence interval for each model term, drawn horizontally, with a vertical reference line at zero."
broom::tidy(moth_glm, conf.int = TRUE, conf.level = .9) |>
  gf_pointrange(estimate + conf.low + conf.high ~ term) |>
  gf_hline(yintercept = 0, linetype = "dashed", col = "gray") +
  coord_flip()
...
```{r}
#| fig-alt: "Plot showing an estimate and its confidence interval for each model term except the intercept, drawn horizontally, with a vertical reference line at zero."
broom::tidy(moth_glm, conf.int = TRUE, conf.level = .9) |>
