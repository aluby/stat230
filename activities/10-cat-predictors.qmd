...
#| fig-width: 3.75
#| out-width: 60%
#| fig-alt: "A blank grid with evenly spaced gridlines, for sketching a fitted model."
graph_paper
```
...
#| fig-width: 3.75
#| out-width: 60%
#| fig-alt: "A sketch with Age on the x-axis and Depression Score on the y-axis, showing three lines with different line styles."
model1
```
