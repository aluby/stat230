...
format: 
  live-html:
    toc: true
    output-file: "05-conditions-tutorial"
engine: knitr
editor: source
execute:
  message: false
...
```{webr}
#| fig-alt: "Scatterplot with critics on the x-axis and audience on the y-axis, with a fitted straight line overlaid."
...
```{webr}
#| layout-ncol: 2
#| fig-alt: "A normal quantile-quantile plot of the model residuals with a reference line, beside a histogram of the model residuals."
