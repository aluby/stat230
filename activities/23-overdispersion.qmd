...
orobanche <- read.csv(here::here("data/orabanche.csv"))
```
...
#| fig-width: 9
#| echo: true
#| fig-alt: "Three panels showing deviance residuals on the y-axis against, respectively, the linear predictor, variety, and root; each panel has a horizontal reference line at zero."
