...
```{r}
bikes_mlr_3var <- lm(rides ~ temp_actual + windspeed + weekend, data = bikes)
bikes_mlr_4var <- lm(rides ~ temp_actual + windspeed*weekend , data = bikes)
...
- About `r round(summary(bikes_mlr_3var)$r.squared, 5)*100`% of the variability in rides is explained by the regression model including temperature, windspeed, and an indicator for weekend
- About `r round(summary(bikes_mlr_4var)$r.squared, 5)*100`% of the variability in rides is explained by the regression model including temperature, windspeed, an indicator for weekend, and an interaction between weekend and windspeed
:::
...
- About `r round(summary(bikes_slr)$adj.r.squared, 4)*100`% of the variability in rides is explained by the regression model including temperature
- About `r round(summary(bikes_mlr2)$adj.r.squared, 4)*100`% of the variability in rides is explained by the regression model including temperature and an indicator for weekend
- About `r round(summary(bikes_mlr_3var)$adj.r.squared, 5)*100`% of the variability in rides is explained by the regression model including temperature, windspeed, and an indicator for weekend
- About `r round(summary(bikes_mlr_4var)$adj.r.squared, 5)*100`% of the variability in rides is explained by the regression model including temperature, windspeed, an indicator for weekend, and an interaction between weekend and windspeed
:::
