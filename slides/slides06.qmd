...
the mean on the original scale, but estimates the median of the original data instead.
:::
...
## Issues with transformations {.incremental}
...
-   Work through the second example on the handout in your groups
