...
d2 <- tibble(
  ...
  price = 50000 + 150 * sqft + ifelse(pool == "Yes", 40000, 0) + rnorm(100, 0, 20000)
)
...
Talk through the answers to the worksheet
...
### <https://aluby.github.io/stat230>

-   where all materials will be hosted
