...
::: {.task .fragment}
`r fa("comments")` What is an example of each type of prediction for the depression/sitting time data? 
:::

## Inference for prediction

Best estimate $\widehat{y}_0 = \widehat{\beta}_0 + \widehat{\beta}_1 x_0$
...
![](slides02_files/figure-html/unnamed-chunk-8-1.png)
:::
::: {.column .fragment width="50%"}
<br>
...
![](slides02_files/figure-html/unnamed-chunk-12-1.gif)
:::
::::
...
```{r}
#| echo: true
predict(nhanes_lm, newdata = data.frame(sedentary_hours = c(8, 10, 12, 14)))
```
